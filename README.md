...
1. Stiahni si inštalačku programu LOGSEQ zo stránky https://logseq.com <br />
![](imgs/1.png)
![](imgs/2.png)
2. Otvor a nainštaluj program LOGSEQ, automaticky sa ti otvorí demo poznámok vytvorených v tom programe <br />
![](imgs/3.png)
![](imgs/4.png)
![](imgs/5.png)
![](imgs/6.png)
